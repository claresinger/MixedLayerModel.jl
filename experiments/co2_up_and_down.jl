...
# upsteps
ARGS = ["500.0"]; include("co2_upstep.jl")
ARGS = ["600.0"]; include("co2_upstep.jl")
ARGS = ["700.0"]; include("co2_upstep.jl")
# ARGS = ["800.0"]; include("co2_upstep.jl")
# ARGS = ["900.0"]; include("co2_upstep.jl")
...
# downsteps
# ARGS = ["1800.0"]; include("co2_downstep.jl")
