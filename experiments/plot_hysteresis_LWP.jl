...
allskylwp = [58.0,53.4,51.6,50.0,48.4,44.4,6.3,5.3,3.7];
lwp = allskylwp ./ cf;
...
p_lwp = scatter(co2, lwp, color=c, marker=:x, markersize=ms, label="", 
                xlabel="CO₂ [ppmv]", ylabel="in-cloud LWP [g/m²]",
                xticks=([400, 800, 1200, 1600]), xlim=[0,2000], ylim=[0,150])
...
plot!(p_lwp, co2, lwp, linewidth=2, linestyle=:dot, color=c, label="")
...
allskylwp = [59.9,13.7,12.5,9.2,8.3,6.8,6.1,5.0];
lwp = allskylwp ./ cf;
...
scatter!(p_lwp, co2, lwp, color=c, marker=:x, markersize=ms, label="")
plot!(p_dR, co2, dR, linewidth=2, linestyle=:dot, color=c, label="")
plot!(p_decoup, co2, S, linewidth=2, linestyle=:dot, color=c, label="")
plot!(p_sst, co2, sst, linewidth=2, linestyle=:dot, color=c, label="")
plot!(p_lhf, co2, lhf, linewidth=2, linestyle=:dot, color=c, label="")
...
scatter!(p_lwp, co2u, lwp, color=c, marker=:circle, markersize=ms, markerstrokewidth=0, label="")
