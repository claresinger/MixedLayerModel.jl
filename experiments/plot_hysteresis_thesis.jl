...
p_dR = scatter(co2u, dR, color=c, marker=:circle, markersize=ms, markerstrokewidth=0, label="", 
                ylabel="ΔR [W/m²]",
                annotation = (100, 100*1.1, text("a)", fontsize=12)),
                xticks=([400, 800, 1200, 1600]), xlim=[0,2000], ylim=[0,100])
p_decoup = scatter(co2u, S, color=c, marker=:circle, markersize=ms, markerstrokewidth=0, label="", 
...
p_sst = scatter(co2u, sst, color=c, marker=:circle, markersize=ms, markerstrokewidth=0, label="", 
                ylabel="SST [K]",
                annotation = (100, (312-286)*1.1+286, text("b)", fontsize=12)),
                xticks=([400, 800, 1200, 1600]), xlim=[0,2000], ylim=[286, 312])
p_lhf = scatter(co2u, lhf, color=c, marker=:circle, markersize=ms, markerstrokewidth=0, label="",
...
p_zi = scatter(co2u, zi, color=c, marker=:circle, markersize=ms, markerstrokewidth=0, label="",
                ylabel="zᵢ [m]",
                xticks=([400, 800, 1200, 1600]), xlim=[0,2000], ylim=[500, 1500])
p_cf = scatter(co2u, cf*100, color=c, marker=:circle, markersize=ms, markerstrokewidth=0, label="", 
...
mkpath("experiments/figures/thesis/")
savefig(p, "experiments/figures/thesis/"*"hystersis_plot_up.png")
...
p = plot(p_dR,p_sst,p_lhf,p_cf, layout=(2,2), 
    ...
    legend=:topright, legendfontsize=10, legendfont=font(10),
    left_margin=10Plots.mm, bottom_margin=7Plots.mm, top_margin=5Plots.mm);
savefig(p, "experiments/figures/thesis/"*"hystersis_plot_updown.png")
...
p = plot(p_dR,p_sst,p_lhf,p_cf, layout=(2,2), 
    ...
    legend=:topright, legendfontsize=10, legendfont=font(10),
    left_margin=10Plots.mm, bottom_margin=7Plots.mm, top_margin=5Plots.mm);
savefig(p, "experiments/figures/thesis/"*"hystersis_plot_wLES.png")
