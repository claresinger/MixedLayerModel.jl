...
ms = 10
c = "crimson"
p1 = scatter(co2, cf*100, color=c, marker=:x, markersize=ms, label="", xlabel="CO\$_2\$ [ppmv]", ylabel="CF [%]",
                xticks=([400, 800, 1200, 1600]), xlim=[100,1700], ylim=[0,110])
p2 = scatter(co2, sst, color=c, marker=:x, markersize=ms, label="", xlabel="CO\$_2\$ [ppmv]", ylabel="SST [K]",
                xticks=([400, 800, 1200, 1600]), xlim=[100,1700], ylim=[288, 316])
plot!(p1, co2, cf*100, linewidth=2, linestyle=:dot, color=c, label="")
plot!(p2, co2, sst, linewidth=2, linestyle=:dot, color=c, label="")
...
c = "royalblue"
scatter!(p1, co2, cf*100, color=c, marker=:x, markersize=ms, label="")
scatter!(p2, co2, sst, color=c, marker=:x, markersize=ms, label="")
plot!(p1, co2, cf*100, linewidth=2, linestyle=:dot, color=c, label="")
plot!(p2, co2, sst, linewidth=2, linestyle=:dot, color=c, label="")
...
ms = 8
c = "crimson"
scatter!(p1, co2, cf*100, color=c, marker=:circle, markersize=ms, markerstrokewidth=0, label="")
scatter!(p2, co2, sst, color=c, marker=:circle, markersize=ms, markerstrokewidth=0, label="")
plot!(p1, co2, cf*100, color=c, linewidth=2, label="")
plot!(p2, co2, sst, color=c, linewidth=2, label="")
...
savefig(p, "experiments/figures/"*exp_path*"AGU-CF-SST.png")
