...
p_zi = scatter(co2u, zi, color=c, marker=:circle, markersize=ms, markerstrokewidth=0,
                label="", ylabel="zᵢ [m]",
                xticks=xtks, xlim=xrange, ylim=[0, 1200])
p_cf = scatter(co2u, cf*100, color=c, marker=:circle, markersize=ms, markerstrokewidth=0,
                ...
                xticks=xtks, xlim=xrange, ylim=[0,100])
p_lwp = scatter(co2u, lwp, color=c, marker=:circle, markersize=ms, markerstrokewidth=0,
                label="", xlabel="CO₂ [ppmv]", ylabel="in-cloud LWP [g/m²]",
                xticks=xtks, xlim=xrange, ylim=[0,150])
...
plot!(p_lwp, co2u, lwp, color=c, linewidth=2, label="")
...
scatter!(p_lwp, co2d, lwp, color=c, marker=:circle, markersize=ms, markerstrokewidth=0, label="")
...
plot!(p_lwp, co2d, lwp, color=c, linewidth=2, label="")
...
scatter!(p_lwp, orig_co2u, lwp, color=c, marker=:circle, markersize=ms, markerstrokewidth=0, label="")
...
plot!(p_lwp, orig_co2u, lwp, color=c, linewidth=1, alpha=0.5, label="")
...
scatter!(p_lwp, orig_co2d, lwp, color=c, marker=:circle, markersize=ms, markerstrokewidth=0, label="")
...
plot!(p_lwp, orig_co2d, lwp, color=c, linewidth=1, alpha=0.5, label="")
...
# save plot w/ LWP
p = plot(p_dR,p_sst,p_zi,p_cf,p_lhf,p_lwp, layout=(2,3), 
    link=:x, size=(1300,650), dpi=300,
    legend=:topright, legendfontsize=12, legendfont=font(12),
    left_margin=10Plots.mm, bottom_margin=7Plots.mm, top_margin=5Plots.mm);
mkpath("experiments/figures/"*exp_path)
savefig(p, "experiments/figures/"*exp_path*"hystersis_plot_lwp.png")
