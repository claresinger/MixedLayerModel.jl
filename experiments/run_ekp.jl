...
# # SSTnorm = (SSTupdn_list - μSST)/σSST;
# # LHFnorm = (LHFupdn_list - μLHF)/σLHF;
...
# prior_α = constrained_gaussian("prior_α", 1.0e-3, 0.02e-3, 0.0, Inf)
# prior_EIS = constrained_gaussian("prior_EIS", 7, 2, 0.0, Inf)
# prior_ECS = constrained_gaussian("prior_ECS", 3, 1, 0.0, Inf)
# prior_Eexport = constrained_gaussian("prior_Eexport", 15, 2, 0.0, Inf)
# prior_SW = constrained_gaussian("prior_SW", 150, 20, 0.0, Inf)
...
# save_directory = homedir * "/experiments/ekp/20221012_LES_" * NNstring * "/"
